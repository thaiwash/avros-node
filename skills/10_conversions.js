...
console.log(conversion)
conversion = instance.Tier2ToTier1(conversion)
console.log(conversion)
conversion = instance.Tier1ToTier3(conversion)
console.log(conversion)
conversion = instance.Tier3ToTier0(conversion)
console.log(conversion)
process.exit(0)